...
// Juz metadata: first words of the first ayah in each juz
export const JUZ_NAMES: Record<number, string> = {
  1: "بِسْمِ ٱللَّهِ",
  2: "سَيَقُولُ ٱلسُّفَهَآءُ",
  3: "تِلْكَ ٱلرُّسُلُ",
  4: "كُلُّ ٱلطَّعَامِ",
  5: "وَٱلْمُحْصَنَـٰتُ",
  ...
  9: "قَالَ ٱلْمَلَأُ",
  10: "وَٱعْلَمُوٓا۟",
  11: "إِنَّمَا ٱلسَّبِيلُ",
  12: "وَمَا مِن دَآبَّةٍ",
  13: "وَمَآ أُبَرِّئُ",
  14: "الٓر",
  15: "سُبْحَـٰنَ ٱلَّذِىٓ",
  16: "قَالَ أَلَمْ",
  17: "ٱقْتَرَبَ",
  18: "قَدْ أَفْلَحَ",
  19: "وَقَالَ ٱلَّذِينَ",
  20: "فَمَا كَانَ جَوَابَ",
  21: "وَلَا تُجَـٰدِلُوٓا۟",
  22: "وَمَن يَقْنُتْ",
  23: "وَمَآ أَنزَلْنَا",
  24: "فَمَنْ أَظْلَمُ",
  25: "إِلَيْهِ يُرَدُّ",
